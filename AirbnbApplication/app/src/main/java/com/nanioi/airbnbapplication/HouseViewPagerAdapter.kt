...
class HouseViewPagerAdapter : ListAdapter<HouseModel, HouseViewPagerAdapter.ItemViewHoler>(differ){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHoler {
        ...
        return ItemViewHoler(inflater.inflate(R.layout.item_house_detail_for_viewpager,parent,false))
    }
