package com.nanioi.musicplayer
...
import com.nanioi.musicplayer.databinding.FragmentPlayerBinding
import com.nanioi.musicplayer.service.MusicDto
import com.nanioi.musicplayer.service.MusicService
...
class PlayerFragment :Fragment(R.layout.fragment_player){
    ...
    private fun initPlayControlButtons(fragmentPlayerBinding: FragmentPlayerBinding){
        ...
        fragmentPlayerBinding.skipPrevImageView.setOnClickListener {
            val precMusic = model.prevMusic() ?:return@setOnClickListener
            playMusic(precMusic)
        }
    }
        ...
        binding?.let{ binding->
            ...
            player?.addListener(object: Player.EventListener{
                override fun onIsPlayingChanged(isPlaying: Boolean) {
                    ...
                    if(isPlaying){
                        binding.playControllImageView.setImageResource(R.drawable.ic_baseline_pause_48)
                    }else{
                        binding.playControllImageView.setImageResource(R.drawable.ic_baseline_play_arrow_48)
                    }
                }
    ...
    private fun updateSeekUi(duration: Long, position: Long) {
        binding?.let {binding->
            ...
            binding.playTimeTextView.text = String.format("%02d:%02d",
                TimeUnit.MINUTES.convert(position,TimeUnit.MILLISECONDS),(position/1000)%60)
            binding.totalTimeTextView.text= String.format("%02d:%02d",
                TimeUnit.MINUTES.convert(duration,TimeUnit.MILLISECONDS),(duration/1000)%60)
        }
    }
