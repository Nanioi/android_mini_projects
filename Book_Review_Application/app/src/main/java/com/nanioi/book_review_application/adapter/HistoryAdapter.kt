package com.nanioi.book_review_application.adapter
...
import com.nanioi.book_review_application.databinding.ItemBookBinding
import com.nanioi.book_review_application.databinding.ItemHistoryBinding
import com.nanioi.book_review_application.model.Book
...
class HistoryAdapter(val historyDeleteClickedListener:(String)->Unit) : ListAdapter<History, HistoryAdapter.HistoryItemViewHolder>(diffUtil) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HistoryItemViewHolder {
        ...
        //view에도 context가 잇어 parent.context로 접근
    }
